# Proyecto con Flask SQLAlchemy
> Creación de un crud básico usando python - flask - SQLAlchemy, con el gestor de base de dato MYSQL.

![](https://miro.medium.com/max/1400/1*VRkgXt_OfD49qf75zAEpaA.png)
